...
<head>
    ...
    <title>Hire Us - Danny Agency</title>
    <meta name="description" content="Hire Danny Agency for top-notch web development services including website design, SEO, marketing, 3D works, and graphic design. Contact us to elevate your online presence.">
    <meta name="robots" content=" index, follow, snippet, archive">
<meta name="keywords" content="hire web developers, website design, SEO services, marketing, 3D graphics, graphic design, Danny Agency, Lagos, Nigeria">
<meta name="author" content="Danny Agency">
...
/* Custom styles for select elements */
    ...
    -moz-appearance: none;
    background-image: url('data:image/svg+xml;charset=US-ASCII,%3Csvg xmlns%3D%22http://www.w3.org/2000/svg%22 viewBox%3D%220 0 4 5%22%3E%3Cpath fill%3D%22%23ffffff%22 d%3D%22M2 5L4 3H0z%22/%3E%3C/svg%3E');
...
select:hover {
    color: #fff;
        ...
        /* Ensure select elements are not too wide */
        select:focus {
            border-color: #777;
            outline: none;
    ...
    background: #222;
        ...
        /* Additional container for form styling */
        .form-group {
            margin-bottom: 1.5em;
        }
...
.success {
  color: #32CD32; /* Lime Green */
    background-color: #F0FFF0; /* Light Green background for better readability */
    border: 1px solid #228B22; /* Forest Green border for a defined look */
    padding: 10px;
    border-radius: 5px;
    flex: 1 1;
    justify-content: center;
...
<body>
    ...
    <nav>
        ...
        <img src="https://firebasestorage.googleapis.com/v0/b/octen-29d12.appspot.com/o/presentations%2FUl5d1%2FchatImages%2F1721687289086_my_logo-removebg-preview.png?alt=media&token=33360df2-8425-4642-9867-209bee52f72e" alt="Logo" class="logo">
       ...
       <ul>
          <li><a class="grad-text" href="index.html">Home</a></li>
           ...
           <br>
            <div class="socials">
            <a href="https://instagram.com/dannyagency" target="_blank"><i class="bi bi-instagram"></i></a>
            <a href="https://www.tiktok.com/@danny_agency_" target="_blank"><i class="bi bi-tiktok"></i></a>
...
<div class="form-wrap">
    ...
    <script>
        (function() {
            emailjs.init("marCvRNYVsiFUrWCP"); // Replace with your EmailJS User ID
        })();

        document.getElementById('contact-form').addEventListener('submit', function(event) {
            event.preventDefault(); // Prevent the default form submission

            emailjs.sendForm("service_0sk5zyp","template_i1nobed", this)
                .then(function() {
                    document.getElementById('success-message').innerHTML = `<div class="success">Email sent successfully</div>`;
                }, function(error) {
...
window.addEventListener('load', () => {
    ...
    <footer>
       <div class="socials">
             <a href="https://instagram.com/dannyagency" target="_blank"><i class="bi bi-instagram"></i></a>
            <a href="https://www.tiktok.com/@danny_agency_" target="_blank"><i class="bi bi-tiktok"></i></a>
           <a href="/" target="_blank"><i class="bi bi-discord"></a>
        </div>
        <a href="#" class="copyright">&copy; 2025 DANNY AGENCY,ALL RIGHTS RESERVEDy</a>
    </footer>
